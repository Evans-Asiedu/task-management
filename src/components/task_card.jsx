export function TaskCard() {
    return (
      <div className="bg-white w-80 rounded-xl shadow-lg p-4">
        ...
        {/* Task Title & Role */}
        <h3 className="text-md font-semibold mt-3">Creating Awesome Mobile Apps</h3>
        ...
        <div className="flex justify-between items-center mt-3">
          ...
          <div className="flex -space-x-2">
            <img src="/avatar1.jpg" className="w-6 h-6 rounded-full border border-white" />
            <img src="/avatar2.jpg" className="w-6 h-6 rounded-full border border-white" />
            <img src="/avatar3.jpg" className="w-6 h-6 rounded-full border border-white" />
          </div>
        </div>
